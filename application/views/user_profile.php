    ...
    <div class="ui segment">
        ...
        <div class="profile_form">
            <div class="ui segment ui input focus">
                <input type="text" id="profileName" name="profileName" placeholder="Profile Name" value="<?php echo $profileData[0]->getProfileName(); ?>" required>
            </div>
            <div class="ui segment ui input focus">
                <input type="email" id="emailAddress" name="emailAddress" placeholder="Email (sara@gmail.com)" value="<?php echo $profileData[0]->getUserEmail(); ?>" required>
            </div>
            <div class="ui segment ui input focus">
                <input type="url" id="avatarUrl" name="avatarUrl" placeholder="Image URL (https://i.imgur.com/MI8uxnl.jpg)" value="<?php echo $profileData[0]->getAvatarUrl(); ?>">
            </div>
            <div class="ui segment ui input focus">
