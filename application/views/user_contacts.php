...
<div style="min-height: 100vh;">
    <div class="search_contact_form" id="search_contact_form">
        ...
        <div class="ui segment ui input focus textField">
            <input type="text" id="searchLastName" name="searchLastName" placeholder="Last Name / Surname" value="" required>
        </div>
...
<script src="/repo/assets/js/underscore-min.js"></script>
<script src="/repo/assets/js/backbone-min.js"></script>
<script type="text/javascript" src="/repo/assets/js/main.js"></script>
